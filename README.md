...
2. **I'm having trouble formatting my output. How do I do it?** Watch [this string formatting video posted with Module 3](https://tamu.video.yuja.com/V/Video?v=16646920&node=70952984&a=205696672). Also check out [this page](String_Format_Printing.md) about string formatting.
